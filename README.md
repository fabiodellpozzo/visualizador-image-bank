...
**Bem-vindo ao mais completo editor Markdown online, criado para o desenvolvedor brasileiro.** Seja para criar um `README.md` impecável para seu projeto no GitHub, documentar sua API, ou simplesmente para visualizar HT```
...
- Colocamos o <aside> e o conteúdo principal em uma row do Bootstrap, com colunas adaptativas (col-12 col-lg-3 e col-12 col-lg-9). Agora o painel não sobrepõe a galeria.
- Removemos posicionamento fixo e bordas conflitantes; o layout flui para telas pequenas (aside fica acima da galeria) e grandes (lado a lado).
